...
//localStorage.setItem("cartItems", JSON.stringify(makeupData));
    ...
    document.querySelector(".smry-cart-total").textContent=`Cart Total : RS.${total} `
...
let acountry = document.getElementById("acountry").value;
 ...
 function removeItem(index){
    ...
    //     z[index].textContent = cartArr[index].price * cartArr[index].count
            ...
            localStorage.setItem("discountPrice",0);
            document.querySelector("#total").textContent=`Cart Total : RS.${newTotal} `
...
document.getElementById("b1").addEventListener("click",b1)
      ...
      function b1(){
        ...
        let b1Obj = {
          image_url: "https://cdn.shopify.com/s/files/1/0906/2558/products/sugar-cosmetics-matte-as-hell-crayon-minis-lipstick-01-scarlett-o-hara-28219914354771_39239823-2ed8-4b8d-b0db-48c857ae0e3f.jpg?v=1642070562",
...
window.location.href = "cart.html"
      ...
      function b2(){
        ...
        let b1Obj = {
          image_url: "https://cdn.shopify.com/s/files/1/0906/2558/products/SMNLL-Mini---Shade-02.jpg?v=1656000101" ,
...
window.location.href = "cart.html"
      ...
      function b3(){
        ...
        let b1Obj = {
          image_url: "https://cdn.shopify.com/s/files/1/0906/2558/products/2-illuminating-pink.jpg?v=1655964128" ,
...
window.location.href = "cart.html"
      ...
      function b4(){
        ...
        let b1Obj = {
          image_url: "https://cdn.shopify.com/s/files/1/0906/2558/products/1_9814781c-2d1a-4019-ba96-94b9df6f2345.jpg?v=1648102353",
